...
/**
 * Implementation of NotificationService for handling return request email
 * notifications.
 * This service creates and sends HTML email templates for approval, rejection,
 * and completion
 * notifications with proper recipient validation using customer email
 * addresses.
 */
@Service
...
public class NotificationServiceImpl implements NotificationService {
    ...
    private String buildApprovalEmailTemplate(ReturnRequest returnRequest) {
        ...
        String approvalDate = returnRequest.getProcessedAt() != null
                ? returnRequest.getProcessedAt().format(DATE_FORMATTER)
                : "Vừa xong";
    ...
    private String buildRejectionEmailTemplate(ReturnRequest returnRequest) {
        String customerName = returnRequest.getOrder().getUser().getFullName();
        String orderNumber = returnRequest.getOrder().getOrderNumber();
        String rejectionReason = returnRequest.getRejectionReason() != null ? returnRequest.getRejectionReason()
                : "Không đáp ứng điều kiện hoàn trả";
    ...
    private String buildCompletionEmailTemplate(ReturnRequest returnRequest) {
        ...
        // Refund info - now credited to wallet
        String refundAmount = String.format("%,.0f đ", returnRequest.getOrder().getTotalAmount());
                            ...
                            <div class="container">
                                ...
                                <div class="content">
                                    ...
                                    <div class="success-box">
                                        ...
                                        <p>đã được nạp vào ví của bạn.</p>
                                    </div>
                                    ...
                                    <div class="bank-info">
                                        <h3>👛 Tiền đã được nạp vào Ví</h3>
                                        <div class="info-item">
                                            <span class="info-label">Hình thức:</span>
                                            <span class="info-value">Nạp vào ví điện tử</span>
                                        </div>
                                        <div class="info-item">
                                            <span class="info-label">Trạng thái:</span>
                                            <span class="info-value"><strong style="color:#2e7d32">✅ Đã nạp ngay lập tức</strong></span>
                                        </div>
                                    </div>

                                    <div class="timeline-box">
                                        <h3>💡 Sử dụng ví</h3>
                                        <p>Số dư ví có thể dùng để thanh toán các đơn hàng tiếp theo</p>
                                    </div>
