...
public class VNPayService {
    ...
    public String createPaymentUrl(Order order) {
        try {
            ...
            vnp_Params.put("vnp_IpAddr", vnp_IpAddr); // Bắt buộc phải có
    ...
    // Các hàm verify và hmacSHA512 giữ nguyên, chỉ đảm bảo dùng StandardCharsets.UTF_8
    public boolean verifyPaymentResponse(Map<String, String> params) {
        // ... Code cũ ...
        // Lưu ý: Đảm bảo encode UTF-8 trong đoạn lặp params
        try {
